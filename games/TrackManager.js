class TrackManager {
    constructor(game) {
        ...
        this.rewards = {
            card: {
                1: { wood: 2 }, 3: { stone: 2 }, 5: { points: 2 }, 7: { mineral: 2 }, 9: { points: 5 }
            },
            food: {
                1: { points: 1 }, 2: { stamina: 2 }, 3: { points: 2 }, 4: { stamina: 4 },
                5: { points: 3 }, 6: { building: 4 }, 7: { points: 5 }, 8: { tool: 4 }, 9: { points: 10 }
            },
            building: {
                1: { points: 2 }, 2: { card: 2 }, 3: { points: 4 }, 4: { mineral: 2 },
                5: { points: 5 }, 6: { food: 8 }, 7: { points: 8 }, 8: { tool: 4 }, 9: { points: 12 }
            },
            tool: {
                1: { points: 3 }, 2: { wood: 8 }, 3: { points: 5 }, 4: { stone: 6 },
                5: { points: 7 }, 6: { knowledge: 12 }, 7: { points: 10 }, 8: { building: 8 }, 9: { points: 15 }
            },
            knowledge: {
                1: { points: 2 }, 2: { mineral: 1 }, 3: { points: 4 }, 4: { mineral: 2 },
                5: { points: 5 }, 6: { mineral: 4 }, 7: { points: 8 }, 8: { mineral: 8 }, 9: { points: 12 }
            }
        };
        this.positions = {};
    }
    ...
    applyReward(playerIndex, column, position) {
        ...
        const rewardText = Object.entries(reward)
            ...
            .join('，');
        const trackToast = `${player.name} 在${this.getColumnName(column)}轨道获得了 ${rewardText}`;
        LogSystem.logAction(trackToast, player.color);
        g.ui.showToast(trackToast);
        g.network.broadcast({ type: 'toast', message: trackToast });
    }
