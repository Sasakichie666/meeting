const cardDefinitions = [
    ...
    // ==================== 新增抽牌卡 ====================
    {
        id: 'card28',
        name: '木材交易',
        description: '花费4木头，抽取2张手牌',
        cost: { wood: 4 },
        costDescription: '花费4木头',
        effect: { type: 'draw_cards', count: 2 },               // 抽2张牌
        discardEffect: { type: 'draw_cards', count: 1 },
        discardDescription: '丢弃：抽1张牌'
    },
    {
        id: 'card29',
        name: '石材交易',
        description: '花费2石头，抽取2张手牌',
        cost: { stone: 2 },
        costDescription: '花费2石头',
    ...
    },
    {
        id: 'card30',
        name: '矿物交易',
        description: '花费2矿物，抽取3张手牌',
        cost: { mineral: 2 },
        costDescription: '花费2矿物',
        effect: { type: 'draw_cards', count: 3 },
        discardEffect: { type: 'draw_cards', count: 1 },
        discardDescription: '丢弃：抽1张牌'
    },
    {
        id: 'card31',
        name: '佳肴交易',
        description: '花费4佳肴，抽取2张手牌',
        cost: { food: 4 },
        costDescription: '花费4佳肴',
        effect: { type: 'draw_cards', count: 2 },
        discardEffect: { type: 'draw_cards', count: 1 },
        discardDescription: '丢弃：抽1张牌'
    },
    {
        id: 'card32',
        name: '知识交易',
        description: '花费2知识，抽取2张手牌',
        cost: { knowledge: 2 },
        costDescription: '花费2知识',
        effect: { type: 'draw_cards', count: 2 },
        discardEffect: { type: 'draw_cards', count: 1 },
        discardDescription: '丢弃：抽1张牌'
    }
